...
if __name__ == "__main__":
    ...
    candidate_seat_ids = filter(
        lambda seat_id: seat_id not in occupied_seat_ids, candidate_seat_ids
    )
    ...
    candidate_seat_ids = filter(
        lambda seat_id: seat_id + 1 in occupied_seat_ids
        and seat_id - 1 in occupied_seat_ids,
        candidate_seat_ids,
    )
